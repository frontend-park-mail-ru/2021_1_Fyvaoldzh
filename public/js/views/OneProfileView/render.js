...
export async function renderProfileEventsTab(profileDataJson) {
...
export async function renderProfileAboutTab(profileDataJson) {
  let changingContent = document.getElementById('changing-content');
  changingContent.innerHTML = profileAboutTabTemplate(profileDataJson);
}

export async function renderProfileSettingsTab() {
  let changingContent = document.getElementById('changing-content');
