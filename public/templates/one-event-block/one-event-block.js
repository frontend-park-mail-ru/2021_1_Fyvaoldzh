...
function pug_style(r){if(!r)return"";if("object"==typeof r){var t="";for(var e in r)pug_has_own_property.call(r,e)&&(t=t+e+":"+r[e]+";");return t}return r+""}function oneEventBlockTemplate(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"public\u002Ftemplates\u002Fone-event-block\u002Fone-event-block.pug":".event\n    .event__photo(style='background: url(http:\u002F\u002F95.163.180.8:1323\u002Fapi\u002Fv1\u002Fevent\u002F' + id + '\u002Fimage) no-repeat center \u002F cover;')\n    .event__text\n        .event__title\n            a(href='#' id=id data-direction='eventPage') #{title}\n        .event__info\n            .event__place #{place}\n            .event__data #{date}\n    .event__chosen"};
...
pug_html = pug_html + "\u003Cdiv" + (" class=\"event__photo\""+pug_attr("style", pug_style('background: url(http://95.163.180.8:1323/api/v1/event/' + id + '/image) no-repeat center / cover;'), true, false)) + "\u003E\u003C\u002Fdiv\u003E";
...
pug_html = pug_html + "\u003Cdiv class=\"event__place\"\u003E";
;pug_debug_line = 7;pug_debug_filename = "public\u002Ftemplates\u002Fone-event-block\u002Fone-event-block.pug";
...
pug_html = pug_html + "\u003Cdiv class=\"event__data\"\u003E";
;pug_debug_line = 8;pug_debug_filename = "public\u002Ftemplates\u002Fone-event-block\u002Fone-event-block.pug";
