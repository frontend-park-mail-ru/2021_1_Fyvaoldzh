...
pug_html = pug_html + "\u003Cinput" + (" class=\"settings-block__input\""+" type=\"text\" name=\"name\""+pug_attr("value", name, true, false)) + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cinput" + (" class=\"settings-block__input\""+" type=\"text\" name=\"birthday\""+pug_attr("value", birthday, true, false)) + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cinput" + (" class=\"settings-block__input\""+" type=\"text\" name=\"city\""+pug_attr("value", city, true, false)) + "\u002F\u003E";
...
pug_html = pug_html + "\u003Cinput" + (" class=\"settings-block__input\""+" type=\"text\" name=\"email\""+pug_attr("value", email, true, false)) + "\u002F\u003E";
