...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function navbarLoggedTemplate(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"public\u002Fcomponents\u002Fnavbar\u002Fnavbar-logged.pug":".container\n  .navbar__row(id='navbarRow')\n    a.logo(href='\u002F' data-direction='main' data-profileId=Uid) QDA\n    .navbar-menu\n      .profile-nav\n        .navbar-profile-avatar(id='navbar-avatar')\n        a.navbar-profile-name(href='#' data-direction='profile')\n          | #{name}\n        a.navbar-menu__logout(href='\u002Fsignup' data-direction='logout')"};
...
pug_html = pug_html + "\u003Ca" + (" class=\"logo\""+" href=\"\u002F\" data-direction=\"main\""+pug_attr("data-profileId", Uid, true, false)) + "\u003E";
;pug_debug_line = 3;pug_debug_filename = "public\u002Fcomponents\u002Fnavbar\u002Fnavbar-logged.pug";
pug_html = pug_html + "QDA\u003C\u002Fa\u003E";
...
pug_html = pug_html + (pug_escape(null == (pug_interp = name) ? "" : pug_interp)) + "\u003C\u002Fa\u003E";
;pug_debug_line = 9;pug_debug_filename = "public\u002Fcomponents\u002Fnavbar\u002Fnavbar-logged.pug";
pug_html = pug_html + "\u003Ca class=\"navbar-menu__logout\" href=\"\u002Fsignup\" data-direction=\"logout\"\u003E\u003C\u002Fa\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"Uid" in locals_for_with?locals_for_with.Uid:typeof Uid!=="undefined"?Uid:undefined,"name" in locals_for_with?locals_for_with.name:typeof name!=="undefined"?name:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}